...
### ローカル作業
#### Issueに対応する作業ブランチをmain(master)から作成(切る)
方針によってはdevelopブランチをサブマスターとして、そこから作成する場合もあります
```
$ git branch feature/issue-1    feature/というプレフィックスを付け、後ろにはイシュー番号や概要をネーミングする
```
| 用語 | 意味 |
| :--- | :--- |
